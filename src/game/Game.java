...
public class Game {
	...
	private void tabuleiroInicial() {
		...
		List<PecaBase> linha3 = List.of(new EmptyHouse(),new Pawn(Pecas.PAWN_BLACK, Jogadores.PRETO, new Posicao(3,1)),new EmptyHouse(),new EmptyHouse(),new EmptyHouse(),new EmptyHouse(),new EmptyHouse(),new EmptyHouse());
